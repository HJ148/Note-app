            ...
            Expanded(
              child: FutureBuilder<List<Note>>(
                ...
                builder: (context, snapshot) {
                  ...
                  /// Thay thế đoạn ListView.builder cũ bằng đoạn này:
...
return MasonryGridView.count(
  ...
  itemBuilder: (context, index) {
    ...
    return _NoteCard(
      // BẮT BUỘC có key để không bị mất chức năng xóa khi cuộn danh sách
...
class _NoteCard extends StatelessWidget {
  ...
  // Cập nhật Constructor để nhận key từ MasonryGridView
  const _NoteCard({
    required Key key, // Buộc phải có key
    required this.note,
    required this.onTap,
  ...
  Widget build(BuildContext context) {
    return Dismissible(
      key: key!, // Sử dụng chính key của widget
      direction: DismissDirection.endToStart,
      // Hiển thị nền đỏ và icon thùng rác khi vuốt (Yêu cầu C của đề bài)
      ...
      // Hộp thoại xác nhận trước khi xóa (Yêu cầu bắt buộc)
      ...
      child: Card(
        margin: EdgeInsets.zero, // Để Dismissible bao trọn toàn bộ Card
        elevation: 3,
        ...
        child: InkWell(
          ...
          child: Padding(
            padding: const EdgeInsets.all(12),
            child: Column(
              mainAxisSize: MainAxisSize.min, // Giúp Grid tính toán độ cao linh hoạt
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // Tiêu đề: In đậm, tối đa 1 dòng, cắt bằng dấu ...
                Text(
                  note.title,
                ...
                const SizedBox(height: 8),
                // Tóm tắt: Chữ nhạt, tối đa 3 dòng
                Text(
                  note.content,
